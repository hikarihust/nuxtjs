  ...
  <footer id="footer" class="bg-white">
      <div class="tcl-container">
          <div class="footer">
              <div class="tcl-row">
                  <!-- Footer Column -->
                  <div class="tcl-col-12 tcl-col-sm-6 tcl-col-md-4 tcl-col-lg-3">
                      <div class="footer-logo">
                          <img src="/assets/images/logo.png" alt="NuxtBlog Logo">
                      </div>
                      <p>© 2020, All Rights Reserved.</p>
                      <p>Created by <a href="https://www.google.com/" target="_blank">Quang</a></p>
                  </div>
                  <!-- Footer Column -->
                  <div class="tcl-col-12 tcl-col-sm-6 tcl-col-md-4 tcl-col-lg-2">
                  ...
                  <!-- Footer Column -->
                  <div class="tcl-col-12 tcl-col-sm-6 tcl-col-md-4 tcl-col-lg-4">
                      <div class="footer-title">
                          <p>Fanpage</p>
                      </div>
